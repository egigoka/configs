...
### aliases
	...
	case "$(uname -s)" in
        Linux)
            ...
            ;;
        Darwin)
            alias updateall='brew update; brew upgrade --no-quarantine --greedy; brew cleanup --prune=all; sudo git -C /opt/macports-wine pull; sudo port selfupdate; sudo port upgrade outdated; sudo port reclaim --enable-reminders'
