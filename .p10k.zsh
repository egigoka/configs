# Generated by Powerlevel10k configuration wizard on 2022-03-03 at 21:42 +05.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 55273.
# Generated by Powerlevel10k configuration wizard on 2025-03-14 at 16:24 +05.
...
# sharp heads, sharp tails, 2 lines, dotted, no frame, sparse, concise,
...
###  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR='·'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=150
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%015F'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%015F'
  ...
  # Custom prefix.
  # typeset -g POWERLEVEL9K_DIR_PREFIX='%000Fin '
...
#  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='✘'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=015
  ...
  #typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=180

  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n@%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n%040F@%046F%m'
